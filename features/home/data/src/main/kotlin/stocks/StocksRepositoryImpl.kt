...
class StocksRepositoryImpl: StockRepository {
    override fun getOwnStocks(): List<Stock> = listOf(
        ...
        Stock("AAPL", "Apple Inc.", UnitOfAccount.USD, 131.93, 131.81, true, R.drawable.apple),
        Stock("YNDX", "Yandex, LCC", UnitOfAccount.RUB,4764.6, 4709.6, false, R.drawable.yandex),
